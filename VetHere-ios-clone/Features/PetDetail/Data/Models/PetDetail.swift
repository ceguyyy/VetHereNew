...
class PetDetail{
    ...
    init(id: UUID, pet_type: String, pet_breed: String, pet_image: String, pet_name: String, pet_color: String, pet_dob: String, medical_record: [MedicalRecord], vaccine_histories: [VaccineHistory]) {
        self.id = id
